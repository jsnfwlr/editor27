...
M.editor_tinymcefour.initialised = false;

M.editor_tinymcefour.init_editor = function(Y, editorid, options) {
    tinymce.init({
        plugins: 'dragmath link',
        selector: 'textarea',
        minWidth: 0,
        skin: 'moodle',
        menubar : false,
        toolbar: "undo redo | styleselect | bold italic | alignleft aligncenter alignright | bullist numlist outdent indent | link unlink | image dragmath"
